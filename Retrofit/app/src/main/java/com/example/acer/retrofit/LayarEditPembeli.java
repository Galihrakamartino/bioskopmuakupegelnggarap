...
public class LayarEditPembeli extends AppCompatActivity {
    EditText edtIdPembeli, edtIdTiket, edtnama, edtalamat, edttelp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Call<PostPutDelPembeli> postPembeliCall = mApiInterface.postPembeli(
                        edtIdPembeli.getText().toString(),
                        edtIdTiket.getText().toString(),
                        edtnama.getText().toString(),
                        edtalamat.getText().toString(),
        ...
        btDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!edtIdPembeli.getText().toString().trim().isEmpty()){
                    ...
                    Call<PostPutDelPembeli> deletePembeli = mApiInterface.deletePembeli(edtIdPembeli.getText().toString());
        ...
        btBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mIntent = new Intent(getApplicationContext(), layarutama.class);
